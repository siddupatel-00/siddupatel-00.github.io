...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "An end-to-end encrypted voice and video calling platform for private, temporary calls. Connect instantly by username with zero logs, zero tracking, and zero stored data.",
    ...
    descriptionList: [
      "End-to-end encrypted voice and video calls powered by WebRTC",
      "Strictly for temporary calls—zero audio, video, or chat data recorded or stored",
      "Instant calling just by entering a username (no phone number or email required)",
      "Completely untraceable—all call session metadata vanishes once finished",
      "Smart presence logic—calls only push through if both users are actively online",
      "Built-in friend request and buddy system with real-time online status",
    ],
  },
  {
