...
const customComponents = {
  ...
  h3: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h3
      className={cn(
        "font-heading mt-8 mb-2 scroll-m-20 text-lg font-semibold tracking-tight",
        className
      )}
      {...props}
    />
  ...
  h4: ({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) => (
    <h4
      className={cn(
        "font-heading mt-8 mb-1 scroll-m-20 text-lg font-semibold tracking-tight",
        className
      )}
      {...props}
    />
  ...
  p: ({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) => (
    <p className={cn("mt-1 mb-1", className)} {...props} />
  ),
  a: ({ className, ...props }: React.HTMLAttributes<HTMLAnchorElement>) => (
    <a
      className={cn("mb-1 font-medium underline underline-offset-4", className)}
      {...props}
    />
  ),
